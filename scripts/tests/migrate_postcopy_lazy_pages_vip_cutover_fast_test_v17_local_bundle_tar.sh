...
RUNC_BUNDLE_DST_WAS_SET="${RUNC_BUNDLE_DST+x}"
RUNC_BUNDLE_DST="${RUNC_BUNDLE_DST:-/mnt/criu/runc-bundle}"
RUNC_BUNDLE_DST_SHARED="${RUNC_BUNDLE_DST_SHARED:-$RUNC_BUNDLE_DST}"
POSTCOPY_BUNDLE_TRANSFER_MODE="${POSTCOPY_BUNDLE_TRANSFER_MODE:-shared_nfs}"
RUNC_BUNDLE_DST_LOCAL="${RUNC_BUNDLE_DST_LOCAL:-/tmp/criu-local-runc-bundle/$NAME/$CP_NAME}"
if [ "$POSTCOPY_BUNDLE_TRANSFER_MODE" = "local_copy" ] && [ -z "$RUNC_BUNDLE_DST_WAS_SET" ]; then
...
POSTCOPY_IMAGE_TRANSFER_MODE="${POSTCOPY_IMAGE_TRANSFER_MODE:-shared_nfs}"
...
POSTCOPY_RESTORE_WATCH_ENABLED="${POSTCOPY_RESTORE_WATCH_ENABLED:-1}"
